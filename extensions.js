...
const EXTENSIONS = [
  ...
  { no: 4, id: "ext04", name: "英語サイト自然要約", category: "reading", tagline: "直訳っぽさゼロの自然な日本語要約", description: "海外ニュースや技術文書を、日本語の記事のように読みやすく3〜5項目で要約する。" },
  { no: 5, id: "ext05", name: "AI文字数調整カウンター", category: "writing", tagline: "文字数を上限ぴったりに自動調整", description: "SNS投稿や資料作成で、指定文字数に収まるよう読みやすさを保ったまま調整する。" },
